...
const initialState: SettingState = {
  ...
  theme: {
    ...
    textOnBG: 'rgba(129, 129, 129, 1)',
    container: 'rgba(129, 129, 129, 1)',
    textOnContainer: 'rgba(255, 255, 255, 0.87)',
    itemCardBG: 'rgba(129, 129, 129, 1)',
    itemCardHoverBG: 'rgba(129, 129, 129, 1)',
    placeHolder: 'rgba(129, 129, 129, 1)',
    button: 'rgba(114, 114, 114, 0.87)',
    inputBorder: 'rgba(129, 129, 129, 1)',
    textInput: 'rgba(129, 129, 129, 1)',
